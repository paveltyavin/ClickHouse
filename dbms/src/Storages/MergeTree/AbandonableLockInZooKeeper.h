...
public:
    ...
    AbandonableLockInZooKeeper(const AbandonableLockInZooKeeper &) = delete;

    AbandonableLockInZooKeeper(AbandonableLockInZooKeeper && rhs) = default;

    AbandonableLockInZooKeeper & operator=(AbandonableLockInZooKeeper && rhs) = default;
